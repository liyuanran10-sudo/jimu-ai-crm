...
# 16:9 横版默认优先使用 OpenAI Images API 支持的 1792x1024。
ASPECT_TO_SIZE = {
    "16:9": "1792x1024",
    "9:16": "1024x1536",
    "1:1": "1024x1024",
...
class GptImage2Generator:
    ...
    def __init__(self, aspect_ratio: str = "16:9") -> None:
        ...
        configured_size = os.getenv("GPT_IMAGE_SIZE") or os.getenv("IMAGE2_SIZE")
        self.default_size = configured_size or ASPECT_TO_SIZE.get(aspect_ratio, "1792x1024")
